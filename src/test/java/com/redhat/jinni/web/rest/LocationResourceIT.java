...
public class LocationResourceIT {
    ...
    private static final Integer DEFAULT_RHIEID = 1;
    private static final Integer UPDATED_RHIEID = 2;
    ...
    private static final Integer DEFAULT_REGIONID = 1;
    private static final Integer UPDATED_REGIONID = 2;
     ...
     *
     * @see com.redhat.jinni.repository.search.LocationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location()
            .rhieid(UPDATED_RHIEID)
            .city(UPDATED_CITY)
            .country(UPDATED_COUNTRY)
            .partner(UPDATED_PARTNER)
            .regionid(UPDATED_REGIONID);
        return location;
    }
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getRhieid()).isEqualTo(DEFAULT_RHIEID);
        assertThat(testLocation.getCity()).isEqualTo(DEFAULT_CITY);
        assertThat(testLocation.getCountry()).isEqualTo(DEFAULT_COUNTRY);
        assertThat(testLocation.getPartner()).isEqualTo(DEFAULT_PARTNER);
        assertThat(testLocation.getRegionid()).isEqualTo(DEFAULT_REGIONID);
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].rhieid").value(hasItem(DEFAULT_RHIEID)))
            .andExpect(jsonPath("$.[*].city").value(hasItem(DEFAULT_CITY)))
            .andExpect(jsonPath("$.[*].country").value(hasItem(DEFAULT_COUNTRY)))
            .andExpect(jsonPath("$.[*].partner").value(hasItem(DEFAULT_PARTNER)))
            .andExpect(jsonPath("$.[*].regionid").value(hasItem(DEFAULT_REGIONID)));
    }
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.rhieid").value(DEFAULT_RHIEID))
            .andExpect(jsonPath("$.city").value(DEFAULT_CITY))
            .andExpect(jsonPath("$.country").value(DEFAULT_COUNTRY))
            .andExpect(jsonPath("$.partner").value(DEFAULT_PARTNER))
            .andExpect(jsonPath("$.regionid").value(DEFAULT_REGIONID));
    }
    ...
    public void updateLocation() throws Exception {
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getRhieid()).isEqualTo(UPDATED_RHIEID);
        assertThat(testLocation.getCity()).isEqualTo(UPDATED_CITY);
        assertThat(testLocation.getCountry()).isEqualTo(UPDATED_COUNTRY);
        assertThat(testLocation.getPartner()).isEqualTo(UPDATED_PARTNER);
        assertThat(testLocation.getRegionid()).isEqualTo(UPDATED_REGIONID);
