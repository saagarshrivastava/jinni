...
@RestController
@RequestMapping("/api/jinni-kafka")
public class JinniKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JinniKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JinniKafkaResource(KafkaProperties kafkaProperties) {
